...
TEXT_La_VIDA_ultras = """ 
📜 الوصف المفصل:
La vida ultras (حياة الإلتراس)
هو أسلوب الحياة التي يعيشها فرد الالتراس في تصرفاته و تعاملاته فيمكن لفرد الالتراس استغلال هوايته كأسلوب للحياة 
أفراد الألتراس فئة من المجتمع اتخذت من الالتراس اسلوبا لتشجيع فريقها المحلي تمتاز بذكائها و أفكارها الخاصة أغلب رواد هذه الفئة من الطبقة المثقفة إما طلابا جامعيين أو عمال يوميين فمكان إلتقائهم سيكون الكورفا 
يمتاز فرد الالتراس بلباسه الخاص فالهوليجانز قديما استعملو طريقة لباسا فريدة للافلات من الشرطة رسخت هذه الطريقة في عالم الالتراس و سميت ب"الكازوال" الذي قلما نشاهده في بلدنا حيث بدأت بالانتشار مؤخرا في اوساط المجتمع 
يتميز  فرد الالتراس الحقيقي بعدم حب الظهور فهو يتخذها حبا و قناعة شخصية عكس البعض الذي اتخذها لجذب الانتباه و التباهي فهاذا يعارض مبادئ الالتراس 
يتميز فرد الالتراس ايضا بكتمان السر فسر المجموعة يستحيل خروجه و يبقى بين الأعضاء.
#curva_harrachia""" 
...
def الانطلاقية_handler(message):
...
@bot.message_handler(func=lambda msg: msg.text == "la vida ultras⚒️")
def la_vida_ultras_handler(message):
    send_long(message.chat.id, TEXT_La_VIDA_ultras)
...
keep_alive()  # هذا يشغل سيرفر Flask ويبقي البوت شغّال
